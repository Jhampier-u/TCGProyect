...
| T-077 | **`special` y `bonus` en el Play Booster** (migración 0016). Con el catálogo completo de Magic —1045 sets, 207 ofrecidos— sólo nueve tenían cartas inalcanzables: los insertos de hoja aparte (Timeshifted, Masterpiece, Inventions) que ninguna plantilla nombraba. Una sola plantilla cubre Magic de 1993 a 2026 | Base de Datos | 2026-08-26 | S028 | `db/migrations/0016_*` |
| T-078 | **Las paralelas de Yu-Gi-Oh! están en las cuatro épocas, no en una** (migración 0017). La 0010 puso `ultimate_rare` y `ghost_rare` sólo en 2008-2016; con los 1032 sets se vio que van de 2004 a 2026. 143 sets topados al 70-74 % | Base de Datos | 2026-08-26 | S028 | `db/migrations/0017_*` |
