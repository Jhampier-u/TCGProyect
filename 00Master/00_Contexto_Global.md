...
**Estado global:** `FASE 4 — INTERFAZ` · **H0–H6 completados salvo Docker** · queda H7 (mazos) y H8 (endurecimiento)
...
| Frontend | Catálogo, acceso, **apertura animada** y colección. Falta el constructor de mazos (H7) | Agente Frontend |
