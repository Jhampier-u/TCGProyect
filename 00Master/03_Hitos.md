...
|---|---|---|---|
| **H0** | Fundamentos | Vault inicializado, ADR-001 resuelto, repo Git, Docker Compose levanta | 🟡 EN CURSO (ADR-001 ✅ · monorepo ✅ · falta `git init` y Docker) |
...
| **H2** | Ingesta | Los 3 conectores pueblan `sets`/`cards`/`card_prints`; catálogo consultable | 🟡 EN CURSO (contrato `GameAdapter` ✅ · faltan T-009 y los 3 adaptadores) |
