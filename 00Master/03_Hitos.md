...
| **H7** | Deckbuilder | CRUD de mazos + validadores por juego + import/export | 🟡 EN CURSO — **backend completo y verificado** (S020). Faltan la interfaz (T-047) e import/export (T-048) |
