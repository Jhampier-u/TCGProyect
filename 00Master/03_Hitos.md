...
| **H2** | Ingesta | Los 3 conectores pueblan `sets`/`cards`/`card_prints`; catálogo consultable | 🟡 EN CURSO (`GameAdapter` ✅ · `RateLimitedClient` ✅ · faltan los 3 adaptadores y T-014) |
