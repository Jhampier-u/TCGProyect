...
| **H4** | Motor de sobres | `POST /api/packs/open` determinista por seed + plantillas por set | 🟡 **MOTOR ✅** verificado con 3.000 sobres reales · el endpoint espera a **H6 (auth)**, no a H3 |
